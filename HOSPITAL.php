        ...
        <table class="table table-bordered table-hover align-middle mb-0">
          ...
          <tbody>
            <tr>                                                                                         
              ...
              <td><a class="btn btn-primary btn-md " href="hedit.php?hos_id=<?php echo $rows["hos_id"] ?>">Edit</a><a class="btn btn-danger btn-md" href="hdelete.php?hos_id=<?php echo $rows["hos_id"] ?>">DELETE</a></td>
